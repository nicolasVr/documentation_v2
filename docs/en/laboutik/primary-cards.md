...
tags: [cashless, android, Primary, Cards]
authors: [Axel]
---
...
- Activate manager mode if you wish.
     - “Manager mode” allows you to cancel an order already placed, even if it is paid. It's a superpower that requires great responsibilities :smile:
- Save.
